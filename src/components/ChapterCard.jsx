...
import RangeSlider, {timeStringToSeconds, secondsToTimeString} from './RangeSlider';
import $ from 'jquery'
import { useNavigate, useOutletContext } from 'react-router-dom';
import { useUpdateEpisodeChapterMutation } from '../app/api';
...
const ChapterCard = ({episodeId, chapterId, chapterTitle, chapterMakerName, chapterTranscript, episodeTranscript, startSeq, endSeq, startTime, endTime, src, sequences, timeStamps, min_step, refresher}) => {
